...
namespace UnityStandardAssets.ImageEffects
{
    ...
    [AddComponentMenu("Image Effects/Rendering/Screen Space Ambient Occlusion (VRWorks)")]
    public class ScreenSpaceAmbientOcclusionVRWorks : MonoBehaviour
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            RenderTexture rtAO = RenderTexture.GetTemporary(source.width, source.height, 0); //RenderTexture.GetTemporary (source.width / m_Downsampling, source.height / m_Downsampling, 0);            
            ...
            // Use appropriate shader based on active feature
            NVIDIA.VRWorks.SetKeywords(m_SSAOMaterial);                 
            ...
            m_SSAOMaterial.SetTexture ("_SSAO", rtAO);
            Graphics.Blit (m_Visualize ? rtAO : source, destination, m_SSAOMaterial, 4);
