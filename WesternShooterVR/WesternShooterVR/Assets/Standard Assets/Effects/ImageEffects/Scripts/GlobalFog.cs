...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class GlobalFog : PostEffectsBase
	{
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            NVIDIA.VRWorks.SetKeywords(fogMaterial);
      ...
      var sceneMode= RenderSettings.fogMode;
        ...
        static void CustomGraphicsBlit (RenderTexture source, RenderTexture dest, Material fxMaterial, int passNr)
		{
            ...
            {
              Vector4 ST = new Vector4(0.5f,1,0.5f * ((int)Camera.main.stereoTargetEye-1),0.0f);
              fxMaterial.SetVector("_MainTex_ST", ST);
              fxMaterial.SetVector("_CameraDepthTexture_ST", ST);
            }
